...
public class ComprasView extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ComprasView.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Compras de Produtos");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ComprasView().setVisible(true));
    }
