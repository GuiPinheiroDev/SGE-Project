 ...
 * @author User
 */
public class ControleView extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ControleView.class.getName());

    /**
     * Creates new form ControleView
     */
    public ControleView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cBoxFiltragem.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Filtragem", "Id", "Nome", "Custo", "Venda", "Quantidade", "Fornecedor", "Categoria", "Status" }));
        ...
        tblControle.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Custo", "Venda", "Quantidade", "Fornecedor", "Categoria", "Status"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ControleView().setVisible(true));
    }
